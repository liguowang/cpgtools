...
CpG IDs or genomic-locus identifiers. For example::
...
genomic locus. It ranges from 0 to 1, where values close to 0 indicate hypo (low)
methylation and values close to 1 indicate hyper (high) methylation.
...
excluded and the end coordinate is included.

For example::

    chr1    10    15

represents the BED interval ``chr1:11-15`` (1-based, and both start and end are included)
