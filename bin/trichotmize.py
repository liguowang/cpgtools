...
def main():
	...
	parser.add_option("-i","--input-file",action="store",type="string",dest="input_file",help="Input plain text file containing beta values with the 1st row contains sample IDs (must be unique) and the 1st column contains probe IDs (must be unique).  [required]")
