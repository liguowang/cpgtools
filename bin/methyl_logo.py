...
def main():
	...
	parser.add_option("-i","--input-file",action="store",type="string",dest="input_file",help="BED file specifying the methylated C position. This BED file should have at least 4 columns (Chrom, ChromStart, ChromeEnd, strand).  Note: the first base in a chromosome is numbered 0. BED file can be regular or compressed by 'gzip' or 'bz'.")
	...
	parser.add_option("-n","--name",action="store",type='string', dest="motif_name",default='unknown', help="Motif name. default=%default")
