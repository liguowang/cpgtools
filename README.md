...
- **BED3** file only has the first 3 required fields (chrom, chromStart, chromEnd). It is commonly used to represent single genomic regions when "score" and "strand" are not important. 
